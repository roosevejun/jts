...
public class JTSShape implements Shape {
    ...
    protected Polygon createRect(double x, double y, double w, double h) {
        Coordinate[] coordinates = new Coordinate[]{new Coordinate(x, y), new Coordinate(x + w, y),
                new Coordinate(x, y + h), new Coordinate(x + w, y + h)};
        PackedCoordinateSequence shell = new PackedCoordinateSequence.Double(coordinates, 2);
